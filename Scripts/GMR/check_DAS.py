...
def main(db_table):
    """
    Check database DAS table against GMR DataSources table
    """
    ...
    try:      
        ...
        arcpy.AddMessage("Successfully connected to GMR DataSources table")
    ...
    # turn GMR DataSources table into df
    ...
    # Find table records not identical to GMR DataSources table
    ...
    arcpy.AddMessage(f"Source(s) not matching the GMR DataSources table:\n"
